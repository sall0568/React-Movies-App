    ...
    <div className="about-page">
      ...
      <div className="about-content">
        ...
        <section className="features-grid">
          ...
          <div className="features">
            <div className="feature-card">
              ...
              <p>
                Recherchez parmi des milliers de films et séries avec un système
                de recherche en temps réel et des filtres avancés.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p>
                Consultez les synopsis, notes, casting, bandes-annonces et bien
                plus encore.
              </p>
            </div>
          ...
          <div className="tmdb-attribution-about">
            ...
            <div className="tmdb-info-box">
              <p>
                ...
                informations sur plus de 800 000 films et 100 000 séries TV. Les
                données incluent :
              </p>
              <ul>
        ...
        <section className="open-source">
          <h2>💡 Open Source</h2>
          <p>
            Le code source de cette application est disponible sur GitHub à des
            fins éducatives. N'hésitez pas à consulter le code pour apprendre ou
        ...
        <section className="contact-section">
          <h2>📧 Contact</h2>
          <p>
            Vous avez des questions, des suggestions ou vous avez trouvé un bug
        ...
        <section className="version-info">
          <p className="version">Version 2.0.0 • {new Date().getFullYear()}</p>
