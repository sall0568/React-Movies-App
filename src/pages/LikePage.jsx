// src/pages/LikePage.jsx - AVEC SEO OPTIMISÉ
...
const LikePage = () => {
  ...
  return (
    <>
      <SEOHelmet
        title="Mes Favoris - CinéScope | Films et Séries Préférés"
        description="Gérez votre collection personnelle de films et séries préférés sur CinéScope. Organisez, triez et retrouvez facilement vos coups de cœur."
        type="website"
      />
